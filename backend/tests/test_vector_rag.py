...
class VectorRagTests(unittest.TestCase):
    ...
    def test_index_clone_messages_passes_chunks_to_vector_store(self):
        ...
        fake_vector_store = types.ModuleType("app.services.vector_store")
...
class _temporary_vector_store:
    ...
    def __enter__(self):
        self.original = sys.modules.get("app.services.vector_store")
        sys.modules["app.services.vector_store"] = self.fake_module
    ...
    def __exit__(self, exc_type, exc, tb):
        if self.original is None:
            ...
            sys.modules["app.services.vector_store"] = self.original
