"""聊天 + 语音合成：/api/v1/clones/{id}/{chat,speak}。"""
...
from app.models.clone import ChatReply
...
from app.services.chat_engine import extract_text_correction
from app.services.llm import create_chat_engine
from app.services.voice import synthesize_speech

router = APIRouter(prefix="/clones/{clone_id}", tags=["chat"])
