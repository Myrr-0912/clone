"""语音相关：/api/v1/clones/{id}/voice/{status,samples,train}。"""
...
from app.schemas.conversions import decode_voice_samples_payload, profile_to_api
from app.services import voice as voice_module

router = APIRouter(prefix="/clones/{clone_id}/voice", tags=["voice"])
